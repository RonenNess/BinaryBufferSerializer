(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.BinaryBufferSerializer = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
'use strict'
...
},{"../base64-js":1,"../ieee754":3,"buffer":14}],3:[function(require,module,exports){
...
},{"./binary_data":5,"./deserialize_context":7,"./exceptions":8,"./parser":10,"./serialize_context":11}],5:[function(require,module,exports){
/**
...
},{"../external/buffer/index":2,"buffer":14}],7:[function(require,module,exports){
/**
...
},{"./binary_buffer_serializer":4,"./deserialize_context":7,"./exceptions":8,"./parser":10,"./serialize_context":11}],10:[function(require,module,exports){
/**
...
},{"./deserialize_context":7,"./exceptions":8,"./serialize_context":11,"./utf_serialize":12}],11:[function(require,module,exports){
/**
...
},{"./binary_data":5,"./buffer_polyfill":6}],12:[function(require,module,exports){
/**
...
function utf8ToBytes (string, units) {
    ...
    for (let i = 0; i < length; ++i) {
        ...
        let cached = cachedCharCode[codePoint];
        if (cached) {
            bytes.push.apply(bytes, cached);
            continue;
        }
        let startLen = bytes.length;
        ...
        if (!leadSurrogate) {
            ...
            if (codePoint > 0xDBFF) {
                // unexpected trail
                if ((units -= 3) > -1) bytes.push(0xEF, 0xBF, 0xBD)
                cachedCharCode[codePoint] = bytes.slice(startLen, bytes.length);
                continue
            } else if (i + 1 === length) {
                // unpaired lead
                if ((units -= 3) > -1) bytes.push(0xEF, 0xBF, 0xBD)
...
function bytesToUtf (buf, start, end) {
    end = Math.min(buf.length, end)
    const res = []
...
module.exports = {
    utfToBytes: utf8ToBytes,
    bytesToUtf: bytesToUtf,
}
